...
export const ADD_CLIENT_COMPONENT_MESSAGE = 'MESSAGES/ADD_CLIENT_COMPONENT_MESSAGE';
export const ADD_RESPONSE_COMPONENT_MESSAGE = 'MESSAGES/ADD_RESPONSE_COMPONENT_MESSAGE';
export const DROP_MESSAGES = 'MESSAGES/DROP_MESSAGES';
export const HIDE_AVATAR = 'MESSAGES/HIDE_AVATAR';
export const UPLOAD_IMAGE = 'BEHAVIOR/UPLOAD_IMAGE';
export const DELETE_IMAGE = 'BEHAVIOR/DELETE_IMAGE';